...
export default function DubaiPropertyMap() {
  ...
  return (
    <div className="min-h-screen font-sans relative overflow-hidden text-[var(--foreground)] bg-[var(--background)]">
      {/* Header */}
      <header className="absolute top-0 left-0 right-0 z-20 bg-[color-mix(in_oklab,var(--background),white_10%)] backdrop-blur-sm shadow-sm border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-2xl font-bold text-[var(--foreground)]">FINEXA REAL ESTATE</h1>
          </div>
          <div className="flex gap-4">
            <a
              href="/blog"
              className="bg-[var(--primary)] text-[var(--secondary)] px-4 py-2 rounded-lg hover:opacity-90 transition-colors flex items-center gap-2"
            >
