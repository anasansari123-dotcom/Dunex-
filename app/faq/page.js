  ...
  return (
    <div className="min-h-screen bg-[var(--background)] text-[var(--foreground)]">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {/* Contact Section */}
        <div className="mt-16 rounded-2xl p-8 text-center" style={{ background: "color-mix(in_oklab, var(--primary) 8%, white)" }}>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              ...
              className="bg-[var(--primary)] text-[var(--secondary)] px-6 py-3 rounded-lg hover:opacity-90 transition-colors font-medium flex items-center justify-center gap-2"
            >
            ...
            <a
              ...
              className="bg-white border border-[var(--primary)] text-[var(--primary)] px-6 py-3 rounded-lg hover:bg-[color-mix(in_oklab,var(--primary),white_90%)] transition-colors font-medium flex items-center justify-center gap-2"
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
